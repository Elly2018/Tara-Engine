...
namespace Tara {
	std::map<CommomMaterialType, Material*> m_CommomMaterial = std::map<CommomMaterialType, Material*>();
...
#pragma endregion
	...
	std::map<CommomMaterialType, Material*>& CommomMaterial()
	{
		return m_CommomMaterial;
	}

	void RegisterCommom(CommomMaterialType type, Shader* shader) {
