	...
	*/
	...
	public:
		...
		*/
		...
		EventBase<std::function<void()>> EWindow::WindowStartEvent = EventBase<std::function<void()>>();
		EventBase<std::function<void()>> EWindow::ShutdownEvent = EventBase<std::function<void()>>();
		EventBase<std::function<void()>> EWindow::RenderEvent = EventBase<std::function<void()>>();
		EventBase<std::function<void()>> EWindow::PostRenderEvent = EventBase<std::function<void()>>();
		EventBase<std::function<void()>> EWindow::UpdateEvent = EventBase<std::function<void()>>();
		EventBase<std::function<void()>> EWindow::PipelineEvent = EventBase<std::function<void()>>();
