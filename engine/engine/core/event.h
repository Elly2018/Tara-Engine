...
namespace Tara {
	...
	private:
		...
		std::map<int32_t, T> events = std::map<int32_t, T>();
	};
	...
	public:
		...
		EventBase<std::function<void(Scene*)>> SceneCreateEvent = EventBase<std::function<void(Scene*)>>();
		EventBase<std::function<void(SceneObject*)>> SceneObjectCreateEvent = EventBase<std::function<void(SceneObject*)>>();
		EventBase<std::function<void(Component*)>> ComponentCreateEvent = EventBase<std::function<void(Component*)>>();
		EventBase<std::function<void(Scene*)>> SceneDestroyEvent = EventBase<std::function<void(Scene*)>>();
		EventBase<std::function<void(SceneObject*)>> SceneObjectDestroyEvent = EventBase<std::function<void(SceneObject*)>>();
		EventBase<std::function<void(Component*)>> ComponentDestroyEvent = EventBase<std::function<void(Component*)>>();
